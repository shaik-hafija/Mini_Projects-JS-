...
//       gameModal.querySelector("h4").innerText=`hangman-game-images/images/${isVictory?'Congrats!':'Game Over!'}`;
...
const initGame = (button, clickedLetter) => {
    ...
    guessText.innerHTML = `${wrongGuessCount}/${maxGuesses}`;
    hangmanImage.src = `hangman-game-images/images/hangman-${wrongGuessCount}.svg`;
    if (wrongGuessCount >= maxGuesses) return gameOver(false); // Check if wrongGuessCount is greater than or equal to maxGuesses
